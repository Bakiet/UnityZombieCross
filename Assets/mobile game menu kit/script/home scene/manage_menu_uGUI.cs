...
public class manage_menu_uGUI : MonoBehaviour, MPLobbyListener {
	...
	public Transform logo_screen;
		public float show_logo_for_n_seconds;
	public Transform home_screen;
	...
	public Transform no_lives_left_screen;
		public Text no_lives_left_countdown;
	public Transform worlds_screen_automatic;
	public Transform stages_screen_automatic;
	public Transform worlds_screen_manual;
	public manual_world_screen my_manual_world_screen;
	public Transform[] stages_screen_manual;
		public Transform manual_stage_screens_list;
	public Transform map_screen;
	public Transform multi_page_screen;
	public Transform store_screen;
	public Transform loading_screen;
	public Transform current_screen;
	public Transform score_ranck_screen;

	public GameObject store_ico;
	public Info_bar info_bar;
	public bool show_info_bar;
	public bool stage_ico_update_animation_is_running;
	public GameObject score_ranck_ico;



	//profiles
	public GameObject my_new_profile_window;
	public new_profile_pad my_new_profile_pad;
	public Text current_profile_name;
	public GameObject profile_button;
	public Transform profile_screen;
	public GameObject ask_confirmation_window_prefab;
	public bool update_world_and_stage_screen;

	//target buttons for gamepad navigation
	public GameObject home_screen_target_button; 
	public GameObject credit_screen_target_button;
	public GameObject options_screen_target_button;
	public GameObject profile_screen_target_button;
	public GameObject new_profile_window_pad_target_button;
	public GameObject store_screen_target_button;
	public GameObject world_screen_target_button;
	public GameObject stage_screen_target_button;
	public GameObject no_live_screen_button;
	public GameObject score_ranck_target_button;

	//store
	public store_tabs my_store_tabs;
	//ads
	public GameObject internet_off_ico;
	...
	int[] pages;//[world_n]
	public GameObject[] first_stage_ico_in_this_page;
	public RectTransform stage_pages_container;
	public GameObject stage_page;
		public RectTransform scroll_pages;

	public GameObject stage_ico;
	public Transform pages_counter;
	public GameObject page_count_dot;
	public Sprite curret_page_count_dot;
		Image[] dots_array;
		Sprite page_off_dot;
		public GameObject scroll_snap_obj;

	public Transform world_container;
	public ScrollRect world_scroll;
	public GameObject world_ico;

	public AudioClip[] show_mini_star;

	public Sprite[] worlds_ico_imanges;
	public Sprite[] worlds_bk_imanges;
	public Sprite[] worlds_stage_icons;
