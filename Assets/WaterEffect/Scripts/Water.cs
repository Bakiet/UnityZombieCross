...
public class Water : MonoBehaviour {
   ...
   // const float springconstant = 0.01f;
	...
	public float leftposition =-10;
	public float rightposition=20;
	public float topposition=0;
	public float bottonposition=-3;


    void Start()
    {
        //Spawning our water
		SpawnWater(leftposition,rightposition,topposition,bottonposition);
    }
