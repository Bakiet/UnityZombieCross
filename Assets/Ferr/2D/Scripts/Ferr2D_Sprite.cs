...
public class Ferr2D_Sprite : MonoBehaviour
{
    ...
    public float Width {
        get {
			...
			if (renderCom.sharedMaterial.mainTexture != null)
            {
                ppuScale = new Vector2(
					renderCom.sharedMaterial.mainTexture.width  / pixelsPerUnit,
					renderCom.sharedMaterial.mainTexture.height / pixelsPerUnit);
            }
